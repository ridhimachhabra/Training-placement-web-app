...
<body>
    <header class="hidden-sm hidden-md hidden-lg">
        <div class="searchbox">
            <form>
                <h1 class="text-left">econnect</h1>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                        ...
                        <li role="presentation"><a href="http://localhost/econnect/index.php">Timeline </a></li>
                        <li role="presentation"><a href="http://localhost/econnect/send-messages.php">Messages </a></li>
                        <li role="presentation"><a href="http://localhost/econnect/notify.php">Notifications </a></li>
                        <li role="presentation"><a href="#">My Account</a></li>
                        <li role="presentation"><a href="http://localhost/econnect/logout.php">Logout </a></li>
                    </ul>
                </div>
            </form>
        </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    ...
                    <ul class="nav navbar-nav hidden-md hidden-lg navbar-right">
                        <li role="presentation"><a href="http://localhost/econnect/index.php">My Timeline</a></li>
                    ...
                    <ul class="nav navbar-nav hidden-xs hidden-sm navbar-right">
                        <li class="active" role="presentation"><a href="http://localhost/econnect/index.php">Timeline</a></li>
                        <li role="presentation"><a href="http://localhost/econnect/my-messages.php">Messages</a></li>
                        <li role="presentation"><a href="http://localhost/econnect/notify.php">Notifications</a></li>
                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">User <span class="caret"></span></a>
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                ...
                                <li class="divider" role="presentation"></li>
                                <li role="presentation"><a href="http://localhost/econnect/index.php">Timeline </a></li>
                                <li role="presentation"><a href="http://localhost/econnect/send-message.php">Messages </a></li>
                                <li role="presentation"><a href="http://localhost/econnect/notify.php">Notifications </a></li>
                                <li role="presentation"><a href="#">My Account</a></li>
                                <li role="presentation"><a href="http://localhost/econnect/logout.php">Logout </a></li>
                            </ul>
    ...
    <div class="footer-dark">
        <footer>
            <div class="container">
                <p class="copyright">econnect @2018</p>
            </div>
        </footer>
    </div>
                                            ...
                                            $.each(posts, function(index) {
                                                    ...
                                                    if (posts[index].PostImage == "") {
                                                            ...
                                                            $('.timelineposts').html(
                                                                    ...
                                                                    '<li class="list-group-item" id="'+posts[index].PostId+'"><blockquote><p>'+posts[index].PostBody+'</p><img src="" data-tempsrc="'+posts[index].PostImage+'" class="postimg2" id="img'+posts[index].postId+'"><footer>Posted by '+posts[index].PostedBy+' on '+posts[index].PostDate+'<button class="btn btn-default" type="button" style="color:#eb3b60;background-image:url(&quot;none&quot;);background-color:transparent;" data-id=\"'+posts[index].PostId+'\"> <i class="glyphicon glyphicon-heart" data-aos="flip-right"></i><span> '+posts[index].Likes+' Likes</span></button><button class="btn btn-default comment" data-postid=\"'+posts[index].PostId+'\" type="button" style="color:#eb3b60;background-image:url(&quot;none&quot;);background-color:transparent;"><i class="glyphicon glyphicon-flash" style="color:#f9d616;"></i><span style="color:#f9d616;"> Comments</span></button></footer></blockquote></li>'
                                                            )
                                                    }
